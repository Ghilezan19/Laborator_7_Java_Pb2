...
public class MainApp {
    public static void scriere(Set<InstrumentMuzical> instrumente) {
        try{
            ...
            File file=new File("C:\\Users\\ghile\\IdeaProjects\\Laborator_7_Java_Pb2\\src\\main\\resources\\instrumente.json");
        ...
        do
        {
            ...
            switch(opt)
            {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    InstrumentMuzical verif=instrumente.iterator().next();
                ...
                case 8:
                    instrumente.stream().
                            ...
                            map(t->(SetTobe)t).
                            sorted((t1,t2)->Integer.compare(t1.getNr_tobe(),t2.getNr_tobe())).
                            forEach(System.out::println);
                    break;
            }
        }while(true);
